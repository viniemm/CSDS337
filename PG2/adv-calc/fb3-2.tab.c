...
#line 1391 "fb3-2.tab.c"
    break;

  case 8:
#line 60 "fb3-2.y"
                          { (yyval.a) = newcmp((yyvsp[-1].fn), (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1397 "fb3-2.tab.c"
    break;

  case 9:
#line 61 "fb3-2.y"
                          { (yyval.a) = newast('+', (yyvsp[-2].a),(yyvsp[0].a)); }
#line 1403 "fb3-2.tab.c"
    break;

  case 10:
#line 62 "fb3-2.y"
                          { (yyval.a) = newast('-', (yyvsp[-2].a),(yyvsp[0].a));}
#line 1409 "fb3-2.tab.c"
    break;

  case 11:
#line 63 "fb3-2.y"
                          { (yyval.a) = newast('*', (yyvsp[-2].a),(yyvsp[0].a)); }
#line 1415 "fb3-2.tab.c"
    break;

  case 12:
#line 64 "fb3-2.y"
                          { (yyval.a) = newast('/', (yyvsp[-2].a),(yyvsp[0].a)); }
#line 1421 "fb3-2.tab.c"
    break;

  case 13:
#line 65 "fb3-2.y"
                          { (yyval.a) = newast('|', (yyvsp[0].a), NULL); }
#line 1427 "fb3-2.tab.c"
    break;

  case 14:
#line 66 "fb3-2.y"
                          { (yyval.a) = (yyvsp[-1].a); }
#line 1433 "fb3-2.tab.c"
    break;

  case 15:
#line 67 "fb3-2.y"
                          { (yyval.a) = newast('M', (yyvsp[0].a), NULL); }
#line 1439 "fb3-2.tab.c"
    break;

  case 16:
#line 68 "fb3-2.y"
                          { (yyval.a) = newnum((yyvsp[0].d)); }
#line 1445 "fb3-2.tab.c"
    break;

  case 17:
#line 69 "fb3-2.y"
                          { (yyval.a) = newfunc((yyvsp[-3].fn), (yyvsp[-1].a)); }
#line 1451 "fb3-2.tab.c"
    break;

  case 18:
#line 70 "fb3-2.y"
                          { (yyval.a) = newref((yyvsp[0].s)); }
#line 1457 "fb3-2.tab.c"
    break;

  case 19:
#line 71 "fb3-2.y"
                          { (yyval.a) = newasgn((yyvsp[-2].s), (yyvsp[0].a)); }
#line 1463 "fb3-2.tab.c"
    break;

  case 20:
#line 72 "fb3-2.y"
                          { (yyval.a) = newcall((yyvsp[-3].s), (yyvsp[-1].a)); }
#line 1469 "fb3-2.tab.c"
    break;

  case 22:
#line 76 "fb3-2.y"
                    { (yyval.a) = newast('L', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1475 "fb3-2.tab.c"
    break;

  case 23:
#line 78 "fb3-2.y"
                    { (yyval.sl) = newsymlist((yyvsp[0].s), NULL); }
#line 1481 "fb3-2.tab.c"
    break;

  case 24:
#line 79 "fb3-2.y"
                    { (yyval.sl) = newsymlist((yyvsp[-2].s), (yyvsp[0].sl)); }
#line 1487 "fb3-2.tab.c"
    break;
...
#line 88 "fb3-2.y"
                       ...
                       printf("Defined %s\n> ", (yyvsp[-6].s)->name); }
#line 1505 "fb3-2.tab.c"
    break;

  case 28:
#line 92 "fb3-2.y"
                       { yyerrok; printf("> "); }
#line 1511 "fb3-2.tab.c"
    break;


#line 1515 "fb3-2.tab.c"
